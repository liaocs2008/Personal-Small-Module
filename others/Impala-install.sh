...
for package in gcc g++ make automake cmake libtool git libboost-all-dev libbz2-dev libzip-dev libsasl2-dev subversion maven bison flex clang-3.3 python-setuptools libevent1-dev libtbb-dev libgdal-dev openjdk-7-jdk postgresql
do                                                                                 
